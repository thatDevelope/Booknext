	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('admin_email')}}" class="nav-link">Inbox</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin_client')}}" class="nav-link">Client_Messages</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('admin_compose')}}" class="nav-link">Compose</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a href="{{ route('venues1')}}" class="nav-link">
              <i class="link-icon" data-feather="message-square"></i>
              <span class="link-title">Venue</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('hotels2')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('shortlets3')}}" class="nav-link">
              <i class="link-icon" data-feather="feather"></i>
              <span class="link-title">Shortlet</span>
            </a>
          </li>
          <!-- <li class="nav-item nav-category">Shortlet</li> -->
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ route('feature')}}" class="nav-link">Featured</a>
                </li>
                <li class="nav-item">
                  <a href="" class="nav-link">Hot</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('features')}}" class="nav-link">Featured-venue</a>
                </li>
                <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
              <ul class="nav sub-menu">
                <!-- <li class="nav-item">
         blogs.create'         <a href="pages/general/blank-page.html" class="nav-link">Blank page</a>
                </li> -->
                <!-- <li class="nav-item">
			...
			<nav class="navbar">
              ...
              <div class="input-group-text">
                ...
                <ul class="list-unstyled p-1">
                  ...
                  <li class="dropdown-item py-2">
                    <a href="{{ route('admin_register')}}" class="text-body ms-0">
