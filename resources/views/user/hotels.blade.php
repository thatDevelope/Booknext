...
<body>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image"><img src="{{ asset($hotel->property_thambnail) }}" alt="" style="width: 450px; height: 280px;  "></figure>
                                                        <div class="batch"><i class="icon-11"></i></div>
                                                        <span class="category">Featured</span>
                                                    </div>
                                                    <div class="lower-content">
                                                        <div class="author-info clearfix">
                                                            <div class="author pull-left">
                                                                <figure class="author-thumb"><img src="{{ asset($hotel->property_thambnail) }}" alt=""></figure>
                                                                <h6>{{ $hotel->client_name }}</h6>
                                                            </div>
                                                            <div class="buy-btn pull-right"><a href="property-details.html">For Buy</a></div>
                                                        </div>
                                                        <div class="title-text"><h4><a href="property-details.html">{{ $hotel->name }}</a></h4></div>
                                                        <p>{{ $hotel->location }}</p>
                                                        <div class="price-box clearfix">
                                                            <div class="price-info pull-left">
                                                                <h6>Start From</h6>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
        <div class="feature-block-one">
            <div class="inner-box">
                <div class="image-box">
                    <figure class="image">
                        <img src="{{ asset($hotel->property_thambnail) }}" alt="" style="width: 450px; height: 280px;">
                    </figure>
                    <div class="batch"><i class="icon-11"></i></div>
                ...
                <div class="lower-content">
                    <div class="author-info clearfix">
                        <div class="author pull-left">
                            <figure class="author-thumb">
                                <img src="{{ asset($hotel->property_thambnail) }}" alt="">
                            </figure>
                            <h6>{{ $hotel->client_name }}</h6>
                        </div>
                    ...
                    <div class="title-text">
                        <h4><a href="property-details.html">{{ $hotel->name }}</a></h4>
                    </div>
                    <p>{{ $hotel->location }}</p>
                    <div class="price-box clearfix">
                        <div class="price-info pull-left">
                    ...
                    @foreach(explode(',', $property->amenities_id) as $amenity)
                            ...
                            @endforeach
                    <div class="btn-box">
                        <a href="{{route('hotel.details', $hotel->id)}}" class="theme-btn btn-two">See Details</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <ul class="pagination clearfix">
        ...
        @else
            <li><a href="{{ $hotels->previousPageUrl() }}"><i class="fas fa-angle-left"></i></a></li>
        @endif

        <!-- Pagination Elements -->
        @foreach ($hotels->links()->elements as $element)
        ...
        @if ($hotels->hasMorePages())
            <li><a href="{{ $hotels->nextPageUrl() }}"><i class="fas fa-angle-right"></i></a></li>
        @else
