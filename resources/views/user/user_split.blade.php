            ...
            <div class="auto-container">
                <div class="inner-container">
                    <div class="content-box centred">
                        <h2>Event Venues, Shortlets, and Hotels – All in One Place.</h2>
                        <p>Discover top-rated event venues, cozy shortlet apartments, and luxurious hotel rooms all in one place.</p>
                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="field-input">
                                                                ...
                                                                <input type="search" name="search-field" placeholder="Search Venues, Hotels, or Shortlets by Property, Location, or Landmark..." required="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                ...
                                                                <select class="wide">
                                                                   ...
                                                                   <option value="4">Portharcourt</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
