...
<body>
        ...
        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
            ...
            <div class="sticky-header">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="{{asset('frontend/assets/images/logob.png')}}" alt="" style="height:30px;"></a></figure>
                        </div>
                        <div class="menu-area clearfix">
                                    ...
                                    <div class="deals-block-one">
                                        <!-- <div class="inner-box">
                                            ...
                                            <div class="lower-content">
                                                ...
                                                <div class="other-info-box clearfix">
                                                    <div class="btn-box pull-left"><a href="" class="theme-btn btn-two">See Details</a></div>
                                                    <ul class="other-option pull-right clearfix">
                                                        <li><a href=""><i class="icon-12"></i></a></li>
                                                        <li><a href=""><i class="icon-13"></i></a></li>
                                                    </ul>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
        <div class="feature-block-one">
            <div class="inner-box">
                <div class="image-box">
                    <figure class="image">
                        <img src="{{ asset($shortlet->property_thambnail) }}" alt="" style="width: 450px; height: 280px;">
                    </figure>
                    <div class="batch"><i class="icon-11"></i></div>
                    <span class="category">Featured</span>
                </div>
                <div class="lower-content">
                    <div class="author-info clearfix">
                        <div class="author pull-left">
                            <figure class="author-thumb">
                                <img src="{{ asset($shortlet->property_thambnail) }}" alt="">
                            </figure>
                            <h6>{{ $shortlet->client_name }}</h6>
                        </div>
                    ...
                    <div class="title-text">
                        <h4><a href="">{{ $shortlet->name }}</a></h4>
                    </div>
                    <p>{{ $shortlet->location }}</p>
                    <div class="price-box clearfix">
                        <div class="price-info pull-left">
                            <h6>Start From</h6>
                            <h4>{{ $shortlet->amount }}</h4>
                        </div>
                        <ul class="other-option pull-right clearfix">
                            <li><a href=""><i class="icon-12"></i></a></li>
                            <li><a href=""><i class="icon-13"></i></a></li>
                    ...
                    <div class="btn-box">
                        <a href="{{ route('shortlet.details', $shortlet->id)}}" class="theme-btn btn-two">See Details</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @endforeach
                                        ...
                                        <!-- <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image"><img src="{{asset('frontend/assets/images/feature/feature-4.jpg')}}" alt=""></figure>
                                                        <div class="batch"><i class="icon-11"></i></div>
                                                        <span class="category">Featured</span>
                                                    </div>
                                                    <div class="lower-content">
                                                        ...
                                                        <div class="title-text"><h4><a href="property-details.html">{{ $shortlet->name }}</a></h4></div>
                                                        <p>{{ $shortlet->location }}</p>
                                                        <div class="price-box clearfix">
                                                            <div class="price-info pull-left">
                                                                <h6>Start From</h6>
    ...
    <ul class="pagination clearfix">
        ...
        @else
            <li><a href="{{ $shortlets->previousPageUrl() }}"><i class="fas fa-angle-left"></i></a></li>
        @endif

        <!-- Pagination Elements -->
        @foreach ($shortlets->links()->elements as $element)
        ...
        @if ($shortlets->hasMorePages())
            <li><a href="{{ $shortlets->nextPageUrl() }}"><i class="fas fa-angle-right"></i></a></li>
        @else
