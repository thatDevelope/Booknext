...
<body>
    ...
    <nav class="main-menu navbar-expand-md navbar-light">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-xl-4 column">
                                <ul>
                                    ...
                                    <li><a href="agency-list.html">Agency Company</a></li>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{asset('frontend/assets/images/logob.png')}}" alt="" title=""></a></div>
                        ...
                        <div class="tabs-box">
                            <div class="tab-btn-box">
                                <ul class="tab-btns tab-buttons centred clearfix">
                                    <li class="tab-btn active-btn" data-tab="#tab-1">Register</li>
                                    <li class="tab-btn" data-tab="#tab-2">Login</li>
                                </ul>
                            </div>
                                          ...
                                          @csrf
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="password" required="" placeholder="Minimum of 8 character">
                                            </div>
