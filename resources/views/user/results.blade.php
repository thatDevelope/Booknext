        ...
        <header class="main-header">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href=""><img src="{{asset('frontend/assets/images/logob.png')}}" alt="" style="width:30px;"></a></figure>
                        </div>
...
<script>
    ...
    stars.forEach(star => {
        star.addEventListener('click', function () {
            ...
            highlightStars(ratingValue); // Highlight stars based on selection
            submitRating(ratingValue); // Submit rating to server
        });
    });
...
function highlightStars(rating) {
    ...
    stars.forEach(star => {
        ...
        if (starValue <= rating) {
            star.querySelector('i').classList.add('icon-39'); // Filled star
            star.querySelector('i').classList.remove('icon-40'); // Empty star
        } else {
            star.querySelector('i').classList.remove('icon-39'); // Filled star
            star.querySelector('i').classList.add('icon-40'); // Empty star
        }
    });
}
    ...
    const userId = "{{ $property->user_id }}"; // Assuming you have user ID available
    ...
    fetch('/submit-rating', {
        ...
        body: JSON.stringify({
            rating: rating,
            user_id: userId // Sending the user_id (lister)
        })
    })
    .then(response => response.json())
    .then(data => {
        if (data.success) {
            // Update the displayed average rating in real-time
            document.getElementById('average-rating').innerText = data.averageRating;
            document.getElementById('total-reviews').innerText = `${data.totalReviews} Guest Reviews`;

            // Update the rating label
            document.getElementById('rating-label').innerText = getRatingLabel(data.averageRating);
        } else {
...
// Helper function to map numeric ratings to labels
                    ...
                    <div class="left-column pull-left clearfix">
                        ...
                        <div class="author-info clearfix">
                            <div class="author-box pull-left">
                                <figure class="author-thumb"><img src="{{ asset($property->property_thambnail) }}" alt=""></figure>
                                <h6>{{ $property->client_name }}</h6>
                            </div>
                            
                            <ul class="rating clearfix pull-left star-rating"  id="star-rating" >
<!--                                 
                            <p id="average-rating" data-rating="{{ $averageRating }}">{{ $averageRating }}
                            @if($averageRating > 0)
                               {{ $averageRating }} / 5
                            @else
                               No ratings yet
                            ...
                            <!-- Display average rating -->
                                <li data-value="1"><i class="icon-39"></i></li>
                                <li data-value="2"><i class="icon-39"></i></li>
                                <li data-value="3"><i class="icon-39"></i></li>
                                <li data-value="4"><i class="icon-39"></i></li>
                                <li data-value="5"><i class="icon-40"></i></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="property-details-content">
                            ...
                            <div class="carousel-inner">
                                ...
                                @foreach($photos as $photo)
                                      <figure class="image-box"><img src="{{ asset($photo) }}" alt="">
                            ...
                            @foreach(explode(',', $property->amenities_id) as $amenity)
                                <ul class="list clearfix">
                                    <li>{{ $amenity }}</li>
                                        ...
                                        <div class="acc-content current">
                                            <div class="content-box">
                                                ...
                                                <figure class="image-box">
                                                    <img src="{{asset('frontend/assets/images/resource/floor-1.png')}}" alt="">
                                                </figure>
                                            </div>
                                        </div>
                                    </li> -->
                            ...
                            <!-- <div class="statistics-box content-widget">
                                ...
                                <figure class="image-box">
                                    <a href="{{ asset($property->property_thambnail) }}" class="lightbox-image" data-fancybox="gallery"><img src=" {{asset('frontend/assets/images/resource/statistics-1.png')}}" alt=""></a>
                                </figure>
                            </div> -->
 @if(session('success'))
...
@endif
                            ...
                            <div class="schedule-box content-widget">
                                ...
                                <div class="form-inner">
                                    <form action="{{ route('schedule.tour',['id' => $property->id, 'property_type' => $property_type])}}" method="post">
                                        @csrf
                                        <div class="row clearfix">
                        ...
                        <div class="property-sidebar default-sidebar">
                            <div class="author-widget sidebar-widget">
                                <div class="author-box">
                                    <figure class="author-thumb"><img src="{{ asset($property->property_thambnail) }}" alt=""></figure>
                                    <div class="inner">
                                        <h4>{{ $property->client_name }}</h4>
                                        
                                        <ul class="info clearfix">
                                            <li><i class="fas fa-map-marker-alt"></i>{{ $property->address }}</li>
                                            <li><i class="fas fa-phone"></i><a href="tel:03030571965">{{ $property->client_phone_number}}</a></li>
                                        </ul>
                                        <div class="btn-box"><a href="{{ route('payment')}}">Book Online</a></div>
                                    </div>
                                </div>
                                <div class="form-inner">
                                    <form action="{{ route('send.message', ['id' => $property->id, 'property_type' => $property_type]) }}" method="post" class="default-form">
                                        @csrf
                                        <div class="form-group">
                                            <p> <center>Book Offline or call the Number</center></p>
                                            <br>
                                            <input type="text" name="name" placeholder="Your name" required="">
                                        </div>
                                        <div class="form-group">
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
            <div class="inner-box">
                <div class="image-box">
                    <figure class="image">
                        <img src="{{ asset($similar->property_thambnail) }}" alt="Property Image">
                    </figure>
                    <div class="batch">
                        <i class="icon-11"></i>
                    </div>
                ...
                <div class="lower-content">
                    <div class="author-info clearfix">
                        <div class="author pull-left">
                            <figure class="author-thumb">
                                <img src="{{ asset($similar->property_thambnail) }}" alt="Author Thumbnail">
                            </figure>
                            <h6>{{ $similar->client_name }}</h6>
                        </div>
                        <div class="buy-btn pull-right"><a href="">For Buy</a></div>
                    </div>
                    <div class="title-text">
                        <h4><a href="">{{ $similar->name }}</a></h4>
                    </div>
                    <div class="price-box clearfix">
                        <div class="price-info pull-left">
                            <h6>Start From</h6>
                            <h4>{{ $similar->amount }}</h4>
                        </div>
                        <ul class="other-option pull-right clearfix">
                            <li><a href=""><i class="icon-12"></i></a></li>
                            <li><a href=""><i class="icon-13"></i></a></li>
                    ...
                    <p>{{ $similar->short_decp }}.</p>
                    <ul class="more-details clearfix">
                        <li><i class="icon-14"></i>{{ $property->bedrooms }}</li>
                        <li><i class="icon-15"></i>{{ $property->bathrooms }}</li>
                        <li><i class="icon-16"></i>{{ $property->property_size }}</li>
                    </ul>
                    <div class="btn-box"><a href="{{ url($similar->property_type . '/' . $similar->id) }}" class="theme-btn btn-two">See Details</a></div>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <div class="author-info clearfix">
                                            <div class="author pull-left">
                                            @foreach($similarProperties as $similar)
                                                <figure class="author-thumb"><img src="{{ asset($similar->property_thambnail) }}" alt=""></figure>
                                                @endforeach
                                                <h6>Robert Niro</h6>
                                            </div>
