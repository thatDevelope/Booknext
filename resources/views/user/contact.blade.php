...
<body>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <h4>Email Address</h4>
                                <p><a href="mailto:info@example.com">boxzun@gmail.com</a><br /><a href="mailto:info@example.com">info@booknest.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <h4>Phone Number</h4>
                                <p><a href="tel:+23055873407">+2348136904968</a><br /><a href="tel:+23055873408">+2348126469850</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <p>7 kameson ademarawa street, <br />lagos Nigeria</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 map-column">
                        <div class="google-map-area">
                            <div 
                                ...
                                data-map-lat="6.503623008728027" 
                                data-map-lng="3.5839264392852783" 
                                data-icon-path="assets/images/icons/map-marker.png"  
                                data-map-title="Brooklyn, New York, United Kingdom" 
                                data-map-zoom="12" 
                                data-markers='{
                                    "marker-1": [6.503623008728027,3.5839264392852783, "<h4>Branch Office</h4><p>77/99 New York</p>","assets/images/icons/map-marker.png"]
                                }'>
    ...
    <!-- map script -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCI-Cqe6XzZ_LymSBlxNQMypnA3aBPpbEo"></script>
