...
<div class="page-content">
       ...
       <div class="card">
    <div class="card-body">
        <h6 class="card-title">Add Property(NB: The are not all required so fill in the ones you have information about. endeavour to put description) </h6>
            

            <form method="post" action="{{ route('venue')}}" id="myForm" enctype="multipart/form-data">
                @csrf
  ...
  -->
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group mb-3">
                <label class="form-label">Client Name </label>
                <input type="text" name="client_name" class="form-control"  value="{{ Auth::user()->name }}" id="client_name">
            </div>
        </div><!-- Col -->
        <div class="col-sm-6">
            <div class="form-group mb-3">
            ...
            <input type="text" name="client_phone_number" class="form-control"  value="{{ Auth::user()->phonenumber }}">
    ...
    <div class="col-sm-6">
         ...
         <div class="col-sm-6">
            <div class="form-group mb-3">
                ...
                <input type="file" name="photos[]" class="form-control" id="multiImg" multiple="" >
    ...
    <div class="row">
     ...
     <option value="Air Conditioning">Air Conditioning</option>
        ...
        <option value="Gym">Light</option>
        <option value="Gym">Generator</option>
        <option value="Gym">Security</option>
      ...
      <div class="col-sm-12">
          ...
          <textarea name="short_descp" class="form-control" id="exampleFormControlTextarea1" rows="3" required></textarea>
...
<!--   //////////// Facilities Option /////////////// -->
 ...
 <a href="{{ route('venue.display')}}"><button type="button" class="btn btn-primary">View All </button></a>
