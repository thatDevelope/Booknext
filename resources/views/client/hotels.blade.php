...
<div class="page-content">
    ...
    <div class="card-body">
        <h6 class="card-title">Add Property(NB: The are not all required so fill in the ones you have information about. endeavour to put description) </h6>
            ...
            <form method="post" action="{{ route('hotel')}}" id="myForm" enctype="multipart/form-data">
                @csrf
...
<!--   //////////// Facilities Option /////////////// -->
 ...
 <a href="{{ route('hotel.display')}}"><button type="button" class="btn btn-primary">View All </button></a>
