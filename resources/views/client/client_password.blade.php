...
<div class="page-content">
        ...
        <div class="row profile-body">
            ...
            <div class="card rounded">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div>
                   <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<form method="POST" action="{{ route('client.update')}}" class="forms-sample" enctype="multipart/form-data">
				@csrf
